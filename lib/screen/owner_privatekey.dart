...
class OwnerPrivatekey extends StatefulWidget {
  const OwnerPrivatekey({super.key});

  @override
  State<OwnerPrivatekey> createState() => _OwnerPrivatekeyState();
}

class _OwnerPrivatekeyState extends State<OwnerPrivatekey> {
  final _formKey = GlobalKey<FormState>();


  Map<String, dynamic>? _PkeyData;
  ...
  Future<void> _signup() async {
    ...
    final result = await api.fetchAdminPkey();
    if (result != null) {
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  if (_PkeyData != null) ...[
                    _buildCard('주소', _PkeyData!['address'] ?? '-'),
                    _buildCard('개인키', _PkeyData!['private_key'] ?? '-'),
